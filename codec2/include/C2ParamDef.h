...
public:
    ...
    const static std::initializer_list<C2FieldDescriptor> FIELD_LIST; // TODO assign here
...
template<typename S, int ParamIndex, unsigned TypeFlags>
const std::initializer_list<C2FieldDescriptor>
...
#if 1
template<typename T>
const std::initializer_list<C2FieldDescriptor> C2SimpleValueStruct<T>::FIELD_LIST = { C2FIELD(value, "value") };
template<typename T>
const std::initializer_list<C2FieldDescriptor> C2SimpleValueStruct<T[]>::FIELD_LIST = { C2FIELD(value, "value") };
template<typename T>
const std::initializer_list<C2FieldDescriptor> C2SimpleArrayStruct<T>::FIELD_LIST = { C2FIELD(values, "values") };
#else
